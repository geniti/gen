                ...
                <div className="flex items-center justify-between w-full md:w-auto">
                  ...
                  <div className="-mr-2 flex items-center md:hidden">
                    <button
                      onClick={handleClick}
                      type="button"
                      class="bg-white dark:bg-yellow-400  toggle rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-400 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-400"
                      id="main-menu"
                      aria-haspopup="true"
                    >
              ...
              <div className="px-5 pt-4 flex items-center justify-between">
                ...
                <div className="-mr-2">
                  <button
                    onClick={handleClick}
                    type="button"
                    class="bg-white dark:bg-yellow-400  rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-400 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-400"
                  >
              ...
              >
                <div className="px-2 pt-2 pb-3 space-y-1" role="none">
                  ...
                  <div role="none" href="mailto:hallo@geniti.nl" >
                    <a
                      className="block w-full px-5 py-3 text-center font-medium  text-white bg-yellow-500 hover:bg-yellow-400"
                      role="menuitem"
                    >
                      Stuur een bericht
                    </a>
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="text-center sm:text-center lg:text-left">
              <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                <span className="block xl:inline dark:text-white">Bespreek de </span>
                <span className="block text-yellow-400 xl:inline">mogelijkheden
                </span>
              </h1>
              <p className="mt-3 text-base text-gray-400 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
              Of het nu gaat om een nieuwe website, een online strategie, hulp met online marketing of voor het bouwen van maatwerk software. Geniti denkt graag met je mee! ​
...
Contact formulier                    </a></Link>
                </div>

                <div className="mt-3 sm:mt-0 sm:ml-3">
                  <a
                    href="mailto:hallo@geniti.nl"
